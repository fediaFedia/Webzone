...
var arrTitles = ["#fff000","#000fff"];
	...
	$windowControls
		...
		"<div>Font Color</div><br>",
			"<div class='squareBig' style='background:#000;'></div>",
				...
				"<div class='squareBig fontColor' style='background:grey'></div>",
								"<input id='colorText' type='color'></input>"
		...
		"<div>Background Color</div><br>",
			"<div class='squareBig' style='background:#000;'></div>",
				...
				"<input id='colorBG' type='color'></input>",
				"<div class='squareBig bgColor' style='background:#222;'></div><br><br>"
