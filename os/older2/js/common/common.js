...
var arrTitles = ["#fff000","#000fff"];
	...
	$windowControls
		...
		.append(
		"<br><div>Layout: <select id='type'><option value='linux'>Linux</option><option value='mac'>Mac OS</option><option value='windows'>Windows</option></select></div><br>",
		...
		"<div>Background Color</div><br>",
			...
			"<hr>"
				...
				.append(
		"<div>Background Image <div title='E' class='rank r1'></div></div><br>",
