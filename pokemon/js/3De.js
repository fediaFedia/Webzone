...
var card_front = THREE.ImageUtils.loadTexture( imageData, {}, function(){ render(); } );
var card_back = THREE.ImageUtils.loadTexture( imageDataBack, {}, function(){  } );
	var card_stars = THREE.ImageUtils.loadTexture( imageStars, {}, function(){ render(); } );
...
var textureToShow = id;
  card_front_material.map = THREE.ImageUtils.loadTexture( arr[id], {}, function(){ render() } );
